      ...
      <div className="container flex items-center justify-between h-16 px-4 md:px-6">
        <div className="flex items-center gap-4">
          <Link href="#" className="flex items-center gap-2" prefetch={false}>
            <div className="text-primary text-4xl font-bold font-mono">Up</div>
          </Link>
          <div className="relative flex-1">
            ...
            <Input
              type="search"
              placeholder="Search..."
              className="pl-10 pr-4 h-9 rounded-md bg-muted text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
            />
          </div>
        </div>
        <div className="flex items-center gap-4">
...
function ImageUpIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
